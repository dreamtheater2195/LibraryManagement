...
namespace QuanLyThuVien
{
    public partial class clsTaiKhoanDangNhap : clsDBInteractionBase
    {
        ...
        private SqlString m_sTenDayDu, m_sMatKhau, m_sTenDangNhap;
        #endregion
        ...
        public override bool Insert()
        {
            ...
            try
            {
                ...
                scmCmdToExecute.Parameters.Add(new SqlParameter("@TenDayDu", SqlDbType.NVarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sTenDayDu));
        ...
        public override DataTable SelectOne()
        {
            ...
            try
            {
                ...
                if (dtToReturn.Rows.Count > 0)
                {
                    ...
                    m_sTenDayDu = dtToReturn.Rows[0]["TenDayDu"] == System.DBNull.Value ? SqlString.Null : (string)dtToReturn.Rows[0]["TenDayDu"];
